...
public abstract class AbstractSortedMap<K, V>
  ...
  protected AbstractSortedMap() {
    this(
        new DefaultComparator<K>()); // default comparator uses natural ordering
  }
   ...
   * @return a negative integer, zero, or a positive integer as the first
   *     argument is less than, equal to, or greater than the key of the second
   *     argument.
   */
   ...
   * @return a negative integer, zero, or a positive integer as the first
   *     argument's key is less than, equal to, or greater than the second
   *     argument.
   */
